...
Blockly.JavaScript['text_join'] = function(block) {
  ...
  switch (block.itemCount_) {
    ...
    case 1:
      element = Blockly.JavaScript.valueToCode(block, 'ADD0',
          Blockly.JavaScript.ORDER_NONE) || '\'\'';
      codeAndOrder = Blockly.JavaScript.text.forceString_(element);
      return codeAndOrder;
    case 2:
      element0 = Blockly.JavaScript.valueToCode(block, 'ADD0',
          Blockly.JavaScript.ORDER_NONE) || '\'\'';
      element1 = Blockly.JavaScript.valueToCode(block, 'ADD1',
          Blockly.JavaScript.ORDER_NONE) || '\'\'';
      code = Blockly.JavaScript.text.forceString_(element0)[0] +
...
Blockly.JavaScript['text_charAt'] = function(block) {
  ...
  switch (where) {
    ...
    case 'LAST':
      ...
      return [code, Blockly.JavaScript.ORDER_FUNCTION_CALL];
    case 'FROM_START':
      at = Blockly.JavaScript.getAdjusted(block, 'AT');
      // Adjust index if using one-based indices.
      code = text + '.charAt(' + at + ')';
      return [code, Blockly.JavaScript.ORDER_FUNCTION_CALL];
    case 'FROM_END':
      at = Blockly.JavaScript.getAdjusted(block, 'AT', 1, true);
 ...
 * @private
 */
Blockly.JavaScript.text.getIndex_ = function(stringName, where, optAt) {
  if (where == 'FIRST') {
    return '0';
