...
export const KEYPAD_ICON = String.fromCodePoint(0x1F522);
...
export const TEXT_ICON = String.fromCodePoint(0x1F4DD);
...
export const DATA_ICON = String.fromCodePoint(0x1F5C4) + String.fromCodePoint(0xFE0F);
